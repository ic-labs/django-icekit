    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layout', models.ForeignKey(blank=True, to='icekit.Layout', related_name='icekit_plugins_location_location_related', null=True)),
                ('publishing_linked', models.OneToOneField(to='icekit_plugins_location.Location', related_name='publishing_draft', on_delete=django.db.models.deletion.SET_NULL, null=True, editable=False)),
            ],
        ),
