...
class InstagramEmbedItem(ContentItem):
    """
    ...
    height = models.PositiveIntegerField(max_length=255, blank=True, null=True)
    width = models.PositiveIntegerField(max_length=255, blank=True, null=True)
    thumbnail_url = models.CharField(max_length=255, blank=True)
    thumbnail_width = models.PositiveIntegerField(max_length=255, blank=True, null=True)
    thumbnail_height = models.PositiveIntegerField(max_length=255, blank=True, null=True)
    provider_name = models.CharField(max_length=255, blank=True)
    title = models.CharField(max_length=512, blank=True)
    html = models.TextField(blank=True)
    version = models.CharField(max_length=20, blank=True)
    author_url = models.CharField(max_length=255, blank=True)
    author_id = models.PositiveIntegerField(max_length=255, blank=True, null=True)
