Creating a new rich content type
================================

Occasionally you'll need to create a new :term:`rich content type`. This can
either be a (polymorphic) subclass of an existing content type, or an entirely
new model.
